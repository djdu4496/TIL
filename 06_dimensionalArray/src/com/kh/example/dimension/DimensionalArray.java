...
public class DimensionalArray {
	public void method1() {
		...
		//		자료형 배열명[][] = new 자료형[행크기][열크기];
		//		자료형[] 배열명[] = new 자료형[행크기][열크기];
		/*int[][]*/ iArr1 = new int[3][5]; // 정변 배열 : 행과 열의 크기가 고정적인 배열		
	}
	public void method2() {
		// int형의 iArr이라는 배열 이름의 3행 5열짜리 배열 생성
		...
		System.out.println("iArr.length : " + iArr.length);  // iArr.length : 행의 길이
		System.out.println("iArr[0].length : " + iArr[0].length);
	...
	public void method3() {
		// 가변 배열
		// 		행 크기는 정해져 있으나 각 행에 대한 열 크기가 정해여 있지 않은 상태
